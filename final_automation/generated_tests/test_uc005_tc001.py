"""
Test Case: Only dynamically loaded links (AJAX, JavaScript-triggered) - Positive Flow
Test ID: UC005_TC001
Description: Verify only dynamically loaded links (ajax, javascript-triggered) works correctly with valid inputs
...
class TestUC005_TC001:
    """
    Only dynamically loaded links (AJAX, JavaScript-triggered) - Positive Flow
    """
    ...
    def test_uc005_tc001_positive_flow(self):
        """
        Test: Only dynamically loaded links (AJAX, JavaScript-triggered) - Positive Flow
    ...
    def _generate_report(self):
        ...
        current_test = test_case_details.get('UC005_TC001', {
            'name': 'UC005_TC001',
        ...
        json_report_file = f"reports/{'UC005_TC001'.lower()}_links_report.json"

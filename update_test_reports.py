#!/usr/bin/env python
"""
Script to update all test files to use simple JSON reporting with URL information
"""
...
def remove_html_generation_and_add_console_output(filepath):
    """Remove HTML generation from a test file and add simple console URL output"""
...
def update_all_test_directories():
    ...
    for directory in test_directories:
        ...
        for filepath in test_files:
            remove_html_generation_and_add_console_output(filepath)

def main():
    """Update all test files to use simple JSON reporting"""
    print("Updating all test files to use simple JSON reporting with URL information...")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("✅ Test report update complete!")
    print("\nAll tests now use:")
